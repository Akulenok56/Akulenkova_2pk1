namespace pz_08
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[][] arr = new int[10][]; // создаем двумерный массив размером 10 для целых чисел 
            ...
            for (int i = 0; i < lastNum.Length; i++)
            {
                lastNum[i] = arr[i].Max(); // присваиваем элементу массива lastNum максимальное значение из элементов  массива arr
                Console.Write(lastNum[i] + " ");
            }
            Console.WriteLine();
